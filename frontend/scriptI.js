document.addEventListener('DOMContentLoaded', () => {
    ...
    const initialComments = [
        { name: 'Diogo21', text: 'Vamos India! 🇮🇳🔥', time: '2m ago', avatar: 'https://randomuser.me/api/portraits/men/32.jpg' },
        { name: 'Beatriz_Fan', text: 'Virat is the GOAT! 🐐❤️', time: '3m ago', avatar: 'https://randomuser.me/api/portraits/women/44.jpg' },
        { name: 'JoaoSilva', text: 'Este é o nosso ano! 🏆', time: '4m ago', avatar: 'https://randomuser.me/api/portraits/men/62.jpg' },
        { name: 'Marta07', text: 'Força India! 💪🇮🇳', time: '5m ago', avatar: 'https://randomuser.me/api/portraits/women/68.jpg' },
        { name: 'TheRedArmy', text: 'India até morrer! 🔥', time: '6m ago', avatar: 'https://randomuser.me/api/portraits/men/90.jpg' }
    ];
    ...
    const liveMessages = [
        { name: 'Rahul_Fan', text: 'What a goal! ⚽', avatar: 'https://randomuser.me/api/portraits/men/11.jpg' },
        { name: 'Priya_S', text: 'Gurpreet! 🧤', avatar: 'https://randomuser.me/api/portraits/women/12.jpg' },
        { name: 'Amit94', text: 'Come on Blue Tigers! 🇮🇳', avatar: 'https://randomuser.me/api/portraits/men/33.jpg' }
    ];
    ...
    countryBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            // we will let the ahref take over
        });
    });
...
window.renderCart = function() {
    ...
    window.cartItems.forEach((item, index) => {
        html += '<li style="display: flex; justify-content: space-between; margin-bottom: 10px; border-bottom: 1px solid rgba(255, 255, 255, 0.1); padding-bottom: 8px;">' +
                    ...
                    '<span style="color: #ff6600; font-weight: 700;">₹ ' + item.price.toLocaleString('en-IN') + '</span>' +
                 '</li>';
        total += item.price;
    });
    
    html += '</ul>';
    html += '<div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 1.1rem; color: #ffffff; margin-top: 15px; border-top: 2px solid rgba(255, 102, 0, 0.3); padding-top: 12px;">' +
                '<span>Total:</span>' +
                '<span style="color: #ff6600; font-weight: 800;">₹ ' + total.toLocaleString('en-IN') + '</span>' +
             '</div>';
